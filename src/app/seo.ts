...
export const SITE = {
  ...
  description:
    'Ілля Літун — засновник освітньої екосистеми TURBO EDUCATION (Forbes Next 250). Консалтинг, особисті консультації, стратегічні сесії та клуб для власників освітнього бізнесу.',
  locale: 'uk_UA',
