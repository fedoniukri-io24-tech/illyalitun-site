...
export const SITE = {
  ...
  description:
    'Особистий консалтинг, консультації, стратегічні сесії та клуб для власників онлайн-шкіл від Іллі Літуна — засновника TURBO EDUCATION (Forbes Next 250). Систематизація, зростання прибутку та масштабування EdTech-бізнесу.',
  locale: 'uk_UA',
  language: 'uk',
...
> = {
  ...
  stratSesiya: {
    ...
    description:
      'Інтенсивна стратегічна сесія 8 годин офлайн у Києві або Львові: фінанси, маркетинг, продукт і команда. Повна перебудова онлайн-школи за один день із чітким планом впровадження.',
    keywords: [
